  ...
  return (
    <View style = {styles.container}>
        <View style = {styles.header}>
            <Image style = {styles.imgheader} source={require('../img/vs_blue.png')}></Image>
            <View style = {styles.contentInfoPhone}>
                ...
                <View style = {styles.contenttxtColorPhone}>
                    ...
                    <Text style = {styles.txtdo}> xanh</Text>
                </View>
        ...
        <View style = {styles.contentColor}>
                ...
                <TouchableOpacity style = {styles.btnXong} onPress={()=>{  navigation.navigate("bluehome");}}>
